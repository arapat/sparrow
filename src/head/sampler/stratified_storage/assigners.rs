...
pub struct Assigners {
    _updated_examples_s: Sender<ExampleWithScore>,
...
impl Assigners {
    pub fn new(
        ...
        Assigners {
            _updated_examples_s: updated_examples_s,
    ...
    pub fn get_sender(&self) -> Sender<ExampleWithScore> {
        self._updated_examples_s.clone()
    }
        ...
        for _ in 0..self.num_threads {
            ...
            spawn(move|| {
                ...
                while let Some(ret) = updated_examples_r.recv() {
                    ...
                    // if the stratum does not exist, create it.
                    if sender.is_none() {
...
mod tests {
    ...
    fn get_assigner(
        ...
        let assigner = Assigners::new(strata, stats_update_s, num_threads, 10);
        (
            stats_update_r,
            assigner.get_sender(),
            assigner,
